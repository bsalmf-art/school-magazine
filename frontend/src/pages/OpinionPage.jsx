    ...
    <div data-testid="opinion-page">
      <header className="relative bg-[#2D332F] text-[#FAF8F5] paper-grain overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-6 lg:px-10 py-20">
          ...
          <p className="text-lg leading-loose opacity-90 max-w-2xl">
            انقر على الأيقونة التي تُعبّر عن انطباعك بعد قراءة المجلة. تصويتك
            يُساعدنا في تطوير المحتوى ليكون أقرب إلى القارئ.
          </p>
          {!loading && (
            <p
      ...
      <main className="max-w-6xl mx-auto px-6 lg:px-10 py-16">
        ...
        <p className="mt-12 text-sm text-[#5C6660] text-center leading-loose">
          يمكنك التصويت لأي عدد من الأيقونات. انقر مرّة أخرى لسحب تصويتك.
        </p>
      </main>
    </div>
  );
